...
const config = {
  entry: {
    ...
    gg_vendor: ['react', 'react-dom', 'dva', 'react-router', 'antd', 'moment', 'echarts'],
    gg_utils: ['./src/utils/utils.js', './src/utils/const.js']
  },
  ...
  proxy: {
    '/auth': {
      ...
      // target: 'http://api.mobile.daily.gg66.cn', // 预发布测试服
      // "target": "http://api.mobile.daily.gg66.cn",// 日常开发测试服
      "target": "https://pzedu-test.gg66.cn",// 日常开发测试服
      //  "target": "http://10.1.32.12:8001",
      // "target": "http://192.168.1.130:8001",
      // "target": "http://192.168.1.19:8001",
      // target: 'http://192.168.200.120:8001',
    ...
    '/renderserver': {
      ...
      target: 'http://api.mobile.daily.gg66.cn', // 预发布测试服
      // "target": "http://api.mobile.daily.gg66.cn",// 日常开发测试服
      // "target": "http://localhost:3001",// 本地测试
      changeOrigin: true
    },
    '/captcha': {
      //  "target": "https://api.gg66.cn",// 正式服 旧:http://api.mobile.gg66.cn
    ...
    '/v1': {
      ...
      // "target": "http://api.mobile.test.gg66.cn",// 预发布测试服
      // "target": "http://api.mobile.daily.gg66.cn",// 日常开发测试服
      // target: 'https://api-pzgov-daily.gg66.cn/', // 测试服
      "target": "https://pzedu-test.gg66.cn",// 日常开发测试服
      // "target": "http://192.168.1.19:18201",// 本地测试
      // "target": "http://192.168.200.134:18201",// 本地测试
      changeOrigin: true,
      logLevel: 'debug'
    }
  },
  ...
  commons: [
    {
      names: ['gg_index', 'gg_vendor', 'gg_utils'],
      minChunks: Infinity
    }
  ],
  extraBabelIncludes: ['node_modules/_remark-math', 'node_modules/_crypto-js']
}
