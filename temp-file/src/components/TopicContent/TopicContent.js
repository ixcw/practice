...
export default class TopicContent extends Component {
  ...
  renderTopicContent = (topicContent) => {
    ...
    const questionId = topicContent && topicContent.serialNumber && `${topicContent.serialNumber}、` ||
      topicContent && topicContent.serialCode && `${topicContent.serialCode}、` || topicContent && topicContent.questionNum && `${topicContent.questionNum}、` ||
