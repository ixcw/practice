...
*/
  ...
  render() {
    ...
    //     key: '1',
    //     agentUserName: '胡彦斌',
    //     agentPhone: 18000000000,
    //     agentAreaName: '西湖区湖底公园1号',
    //     userNum: 360,
    //     totalMoney: 34646461,
    //     shareMoney: 346431
    //   },
    ...
    //   },
    // ];
    // const reconciliationStatus=[//1.未结清,2:已结清
    //   { value: 1, text: '未对账'},
    //   { value: 2, text: '已对账' },
    //   {value: 3,  text: '对账中' },
    // ];
    // const accountStatus=[//1.未结清,2:已结清
    //   { value: 1, text: '未结清'},
    //   { value: 2, text: '已结清' }
    // ];
    const columns = [//代理商
      ...
      //   render:(text, record)=>(
      //     <span><span  className={styles[record.bankCardId=='未对账'?'gray-point':record.bankCardId=='对账中'?'blue-point':record.bankCardId=='已对账'?'green-point':'']}></span> {record.bankCardId}</span>
      //     )
      // },
      // {
      //   title: '结算状态',
      //   dataIndex: 'bankCardIds',
      //   key: 'yyyerer',
      //   align: 'center',
      ...
      //   onFilter: (value, record) => String(record.status).indexOf(value) === 0,
      //   render:(text, record)=>(
      //   <span><span  className={styles[record.bankCardIds=='未结清'?'gray-point':'green-point']}></span> {record.bankCardIds}</span>
      //   )
      // },
      // {
      //   title: '操作',
      ...
      //   render: (text, record) => (
      //     <a onClick={() => {
      //       // this.showUploadUserExcelModal();
      //       //修改地址栏最新的请求参数
      //       dispatch(routerRedux.push({
      //         pathname: '/agent-monthly-report',
      //         search: queryString.stringify({ id: record.key, type: record.key}),
      //       }));
      //     }}>月报</a>
      //   )
      // }
