...
import { Col, Row, Image, Space, Table, Select } from 'antd';
import styles from './StaffDetails.less'
...
export default forwardRef(function index(props, ref) {
    ...
    const [PrintDomData, setPrintDomData] = useState('')
    useImperativeHandle(ref, () => ({ PrintDomData }))
    useEffect(() => { setPrintDomData(printDom.current) }, [])
            ...
            <div>
                ...
                <div style={cssBox.box_1}>
                    ...
                    <Row style={{ padding: '10px 0' }}>
                        ...
                        <Col span={14}>紧急联系电话</Col>
                    </Row>
                    <Row style={{ padding: '10px 0' }}>
                        <Col span={24}>家庭住址</Col>
                    </Row>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div style={cssBox.box_1}>
                    ...
                    <Space style={{ margin: '20px 0 15px 0' }}>
                        查看体检报告的年份：
                        <Select style={{ width: '100px' }} defaultValue='汉族'>
                            <Option value="male">汉族</Option>
                            <Option value="female">苗族</Option>
                            <Option value="other">布依族</Option>
                        </Select>
                    </Space>
