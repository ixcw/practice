...
const DeleteEmployee = props => {
	const { dispatch, getTeacherList, ListDataPageSize, AllScreening, ListDataCurrentPage, setSelectedRows, getCenterStatWorkers } = props
	...
	/**
	 * 打开删除弹窗
	 * @param	params object	职工详情
	 */
	const showDeleteEmployee = params => {
		if (Array.isArray(params)) {
			// 批量删除
			setEmployeeInfo(params.map(item => item.identityCard).join(','))
		} else {
			// 单条删除
			setEmployeeInfo(params.identityCard)
		}
	...
	return (
		<>
			<Modal title='身份验证' visible={isDeleteEmployeeOpen} onOk={handleOk} onCancel={handleCancel}>
