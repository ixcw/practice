...
function index(props) {
  ...
  useEffect(() => {
    if (account1 !== null && studentDetailsOpen1) {
      setLoading(true);
      //请求字典数据
      dispatch({
  ...
  return (
    <div>
      <Modal
        title="更多详情"
        visible={studentDetailsOpen1}
        width={900}
        footer={null}
        destroyOnClose={true}
        onCancel={() => showStudentDetails1(!studentDetailsOpen1)}
        bodyStyle={{ padding: "0 24px 24px 24px" }}
      >
        <Tabs defaultActiveKey="1" className={styles["StudentDetails"]}>
